"""
    ...
    Usage: txt_to_bedgraph [-i input file] [-c chromosome] [-r resolution] [-t track name] [-d description] [-p positive value color] [-n negative value color] [-o output file]
...
def parse():
    usage = 'python {} [-i input file] [-c chromosome] [-r resolution] [-t track name] [-d description] [-p positive value color] [-n negative value color] [-o output file]'.format(
        __file__)
    ...
    return (args.file, args.chrom, args.resolution, args.name, args.description, args.col, args.alt_col, args.output_file)


if __name__ == '__main__':
    (file, chrom, resolution, name, description, col, alt_col, output_file) = parse()
